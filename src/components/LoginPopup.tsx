...
interface LoginPopupProps {
  ...
  onSwitchToRegister: () => void; // New prop to switch to register popup
}

const LoginPopup: React.FC<LoginPopupProps> = ({ onClose, onLoginSuccess, onSwitchToRegister }) => {
    ...
    <PopupOverlay onClick={onClose}>
      <PopupContainer onClick={(e) => e.stopPropagation()}>
        ...
        <RegisterLinkContainer>
          ...
          <RegisterLink onClick={onSwitchToRegister}>Register here</RegisterLink>
        </RegisterLinkContainer>
      </PopupContainer>
    </PopupOverlay>
  );
